...
public class HTSMessage extends HashMap<String, Object> {
	...
	private static final long serialVersionUID = 2975403077219488636L;
	...
	private static byte[] serializeBinary(String name, Object value)
			throws IOException {
	...
	private static byte[] serializeBinary(Collection<?> list)
			throws IOException {
	...
	private static byte[] serializeBinary(Map<String, Object> map)
			throws IOException {
		ByteBuffer buf = ByteBuffer.allocate(Short.MAX_VALUE);
	...
	private static HTSMessage deserializeBinary(ByteBuffer buf)
			throws IOException {
		byte type, namelen;
		long datalen;
